...
window_ci_mean <- function() {
    ...
    doItAndPrint(glue::glue("BioStat.old::ci_mean_boot({ActiveDataSet()}${Numeric()[1]}, conf_level = {conf_level})"))

    doItAndPrint(glue::glue("BioStat.old::ci_mean_t({ActiveDataSet()}${Numeric()[1]}, conf_level = {conf_level})"))
